 ...
 *
 * <p>환자 코드의 마지막 네 글자에 따른 병과 분류 기준은 다음과 같습니다.</p>
 * <ul>
 *   <li>{@code "_eye"} → Ophthalmology</li>
 *   <li>{@code "head"} → Neurosurgery</li>
 *   <li>{@code "infl"} → Orthopedics</li>
 *   <li>{@code "skin"} → Dermatology</li>
 * </ul>
 *
 * 환자의 코드를 나타내는 문자열 code를 입력받아 위 표에 맞는 병과를 출력하도록 빈칸을 채워 코드를 완성해 주세요.
 * 위 표의 단어로 끝나지 않는다면 "direct recommendation"를 출력합니다
 * */
public class P340204_병과분류 {
